...
<form action="wallet_config.php" method="POST" id="legalcrib_btn" name="legalcrib_btn">
  <script
    ...
    data-prefill.contact="<?php echo $data['prefill']['contact']?>"
     data-prefill.user_id="<?php echo $data['prefill']['user_id']?>"
  ...
  <input type="hidden" name="shopping_order_id" value="<?php echo $data['prefill']['orderid']?>">
  <input type="hidden" name="userid" value="<?php echo $data['prefill']['user_id']?>">
