            ...
            <span class="title-icon mr-10"></span>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="blog__item-right">
                            <a  class="image d-block" target="_blank">
                                <img class="radius-10" src="assets/images/logo/akai.png" alt="image">
                            </a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="blog__item-right">
                            <a  class="image d-block" target="_blank">
                                <img class="radius-10" src="assets/images/logo/presonous.png" alt="image">
                            </a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="blog__item-right">
                            <a  class="image d-block" target="_blank">
                                <img class="radius-10" src="assets/images/logo/krk.png" alt="image">
                            </a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="blog__item-right">
                            <a  class="image d-block" target="_blank">
                                <img class="radius-10" src="assets/images/logo/ik.png" alt="image">
                            </a>
