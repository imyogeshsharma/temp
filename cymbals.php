    ...
    <main>
        ...
        <section class="blog pt-130 pb-130">
            ...
            <span class="title-icon mr-10"></span>
                    <h3 class="fw-600">Checkout the Cymbals from top brands</h3>
                    </div>
                </div>
                <div class="row g-4">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="blog__item-right">
                            <a  class="image d-block" target="_blank" target="_blank">
                                <img class="radius-10" src="assets/images/logo/sabian.png" alt="image">
                            </a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="blog__item-right">
                            <a  class="image d-block" target="_blank" target="_blank">
                                <img class="radius-10" src="assets/images/logo/paiste.png" alt="image">
                            </a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="blog__item-right">
                            <a  class="image d-block" target="_blank" target="_blank">
                                <img class="radius-10" src="assets/images/logo/meinl.png" alt="image">
                            </a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="blog__item-right">
                            <a  class="image d-block" target="_blank" target="_blank">
                                <img class="radius-10" src="assets/images/logo/istanbul.png" alt="image">
                            </a>
